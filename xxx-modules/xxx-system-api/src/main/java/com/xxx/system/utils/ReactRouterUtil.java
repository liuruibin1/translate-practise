...
//import com.xxx.system.graphql.types.ReactRouterF;
//import com.xxx.system.graphql.types.ReactRouterMetaF;
...
//
//    public static List<ReactRouterF> buildTree(List<SysPermissionVO> voList) {
//        List<ReactRouterF> routers = new LinkedList<>();
//        for (SysPermissionVO vo : voList) {
//            ReactRouterF reactRouter = new ReactRouterF();
...
//            //
//            ReactRouterMetaF reactRouterMeta = ReactRouterMetaF.newBuilder()
//                    .title(vo.getName())
//                    .icon(vo.getIcon())
...
//                List<ReactRouterF> childrenList = new ArrayList<>();
//                ReactRouterF children = new ReactRouterF();
...
//                //
//                ReactRouterMetaF tempReactRouterMeta = ReactRouterMetaF.newBuilder()
//                        .title(vo.getName())
//                        .icon(vo.getIcon())
//                        .noCache(vo.getIsCache())
//                        .link(vo.getUrlPath())
...
//                //
//                ReactRouterMetaF tempChildrenReactRouterMeta = ReactRouterMetaF.newBuilder()
//                        .title(vo.getName())
//                        .icon(vo.getUrlPath())
//                        .build();
